...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Snatcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"snatcoin.com", "103.24.66.175"},
    {"aws.snatcoin.com", "18.218.135.144"},
    {"snatzy.win", "159.65.13.167"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Snatcoin is probably already running."), addrBind.ToString().c_str());
        else
